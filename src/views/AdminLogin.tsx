...
const AdminLogin = () => {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: verificationKind === 'signup' ? 'Account verified!' : 'Welcome back!',
          ...
          {authUnavailable && (
            <div className="mb-4 rounded-sm border border-destructive/40 bg-destructive/10 p-3">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Clerk did not finish loading. Refresh the page. If this keeps happening, check your connection.
              </p>
            </div>
          )}
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              <div className="rounded-sm border border-border bg-muted/40 p-3 flex gap-3">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  There is no link — enter the code here to continue.
                </p>
              </div>
